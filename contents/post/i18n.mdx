...
<Callout emoji='💡'>Internationalization에서 i 와 n 사이에 18글자가 있다하여 i18n이라고 부른다고합니다 </Callout>
...
이제 `middleware.ts`에서 `getLocale` 함수를 불러서 결과를 확인해보세요.
...
locale을 변경해주는 네비게이션 컴포넌트를 아래와 같이 만든다.
...
이제 [데모 페이지](https://i18n-next13.vercel.app/ko)를 완성했습니다!
